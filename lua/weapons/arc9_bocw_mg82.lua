...
SWEP.SubCategory = "3Light Machine Guns"
SWEP.AdminOnly = false

SWEP.PrintName = "MG 82"
SWEP.TrueName = "CETME Ameli"
...
SWEP.Description = [[Full-auto light machine gun. Highest fire rate in class with improved aiming speed. Moderate recoil and damage with increased ammo capacity.

The Ameli is a weapon appearing as a light machine gun in Call of Duty: Ghosts, Call of Duty: Black Ops Cold War, and Call of Duty: Mobile, and as a heavy weapon in Call of Duty: Advanced Warfare. It was cut from Call of Duty: Infinite Warfare.

The Ameli returns in Call of Duty: Black Ops Cold War as the MG 82. It was added as part of the Season Four update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_mg82_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_mg82_bocw.mdl"
...
SWEP.RangeMin = 19.05 * 39.37 -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 19.051 * 39.37 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.PhysBulletMuzzleVelocity = 603 * 39.37
...
SWEP.ReloadInSights = false -- not this time american.(lmg)
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_mg82_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.MG82_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.MG82_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.MG82_fire_silenced"                    -- Fire silenced
...
SWEP.CustomizePos = Vector(7, 42, 5)
SWEP.CustomizeRotateAnchor = Vector(7, 0, -5)
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_mg82_muzzle", "bocw_lmg_muzzle_west556"},
        InstalledElements = {"muzzlegone"},
        Installed = "bocw_mg82_muzzle_base",
        Integral = "bocw_mg82_muzzle_base"
    },
    {
        PrintName = "BARREL",
        Bone = "tag_barrel",
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_mg82_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_mg82_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_mg82_sticker3.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 4",
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_mg82"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["mg82_mag_fast"] then
        return anim .. "_fast"
    end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.MG82_boltback", t = 0.5 },
            { s = "ARC9_BOCW.MG82_boltforward", t = 0.9 },
            { s = "ARC9_BOCW.MG82_reload_end", t = 1.6 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["enter_inspect"] = {
        ...
        --Time = 4.5,
        EventTable = {
            { s = "ARC9_BOCW.MG82_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.MG82_inspect_part2", t = 4.5 },
        },
        IKTimeLine = {
            {
                t = 0,
