...
SWEP.TrueName = "Stoner 63A"
SWEP.Class = "Light Machine Gun"
SWEP.Trivia = {
    Manufacturer = "Cadillac Gage",
    Calibre = "5.56x45mm NATO",
    Mechanism = "Gas-operated long stroke piston rotating bolt",
    Country = "USA",
    Year = 1963
}
...
SWEP.Description = [[Full-auto light machine gun. Improved fire rate with a large ammo capacity. Good recoil control and visibility when sustaining fire.
...
SWEP.ViewModel = "models/weapons/arc9/c_arc9_stoner63_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_stoner63_bocw.mdl"
...
SWEP.RangeMin = 21.59 * 39.37 -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 50 * 39.37 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.PhysBulletMuzzleVelocity = 714 * 39.37
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_stoner63_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.AimDownSightsTime = 0.633 -- How long it takes to go from hip fire to aiming down sights.
...
SWEP.ShootSound = "ARC9_BOCW.Stoner63_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.Stoner63_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.Stoner63_fire_silenced"                    -- Fire silenced
...
SWEP.CustomizeRotateAnchor = Vector(16, 0, -4)
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_stoner63_muzzle", "bocw_lmg_muzzle_west556"},
        InstalledElements = {"muzzlegone"},
        Installed = "bocw_stoner63_muzzle_base",
        Integral = "bocw_stoner63_muzzle_base"
    },
    {
        PrintName = "BARREL",
        Bone = "tag_barrel",
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_stoner63_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_stoner63_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3",
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["stoner63_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["stoner63_mag_fast"] then
        return anim .. "_fast"
    end

    if elements["stoner63_mag_mix"] then
        return anim .. "_mix"
    end
end
...
SWEP.Animations = {
    ...
    ["enter_inspect"] = {
        ...
        --Time = 4.5,
        EventTable = {
            { s = "ARC9_BOCW.Stoner63_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.Stoner63_inspect_part2", t = 3 },
        },
        IKTimeLine = {
            {
                t = 0,
